...
consumerKey = 'sm9KTOqBROuqRbHSipW3u73Vb'
consumerSecret = '368HpQURJ7O2D74m95AeVv65tX83ARtlvKSXtWdyj8pcBOdaHn'
accessToken = '1069450084109021184-s0wpqDepDEqI0NZzbfGTEHizZzjWxI'
accessTokenSecret = '8ylxLPYEY8XblkATIGOWalI6BRAUur6hyohxsGbwKPBBk'
...
def app():
	...
	activities=["Tweet Analyzer","Generate Twitter Data", "Tweet Classification"]

	choice = st.sidebar.radio("Select Your Activity",activities)

	n= st.sidebar.slider('No. of Tweets',0,1000,5)
	st.sidebar.write('Made by Madhav Sharma: https://github.com/msharma043510')
	...
	if choice=="Generate Twitter Data":
		...
		def get_data(user_name):
			...
			posts = api.user_timeline(screen_name=user_name, count = n, lang ="en", tweet_mode="extended")
